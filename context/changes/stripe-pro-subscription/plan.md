...
- [x] 4.1 Daily-cap unit tests in get-usage-summary.test.ts — d09c542
- [x] 4.2 Generate integration test for daily_generation_limit_reached — d09c542
- [x] 4.3 `npm run test` passes — d09c542
...
- [x] 5.1 `npm run test` passes — d09c542
- [x] 5.2 `npm run build` passes — d09c542
- [x] 5.3 `npm run astro -- check` passes — d09c542
